...
class exu_issue_test extends AnyFlatSpec with ChiselScalatestTester {
  ...
  "exu_issue" should "accept the instrs from dispatch unit and issue correctly" in {
    test(new exu_issue_queue()) { dut =>
      ...
      dut.io.exu_issue_uop.valid.poke(1.U)
      dut.io.exu_issue_uop.bits(0).valid.poke(1.U)
      dut.io.exu_issue_uop.bits(0).bits.iq_index.poke(2.U)
      dut.io.exu_issue_uop.bits(0).bits.instr_type.poke(InstrType.ALU)
      ...
      dut.io.exu_issue_uop.bits(0).valid.poke(0.U)
      dut.clock.step()
      dut.io.exu_issue_uop.bits(0).bits.fu_signals.opr1_sel.poke(OprSel.REG)
      dut.io.exu_issue_uop.bits(0).valid.poke(1.U)
      dut.io.exu_issue_uop.bits(0).bits.iq_index.poke(2.U)
      dut.io.exu_issue_uop.bits(0).bits.instr_type.poke(InstrType.ALU)
      dut.io.exu_issue_uop.bits(1).valid.poke(0.U)
      ...
      dut.clock.step()
      dut.io.exu_issue_uop.bits(0).valid.poke(1.U)
      dut.io.exu_issue_uop.bits(1).valid.poke(1.U)
      dut.io.exu_issue_uop.bits(0).bits.iq_index.poke(5.U)
      dut.io.exu_issue_uop.bits(1).bits.iq_index.poke(6.U)
      dut.io.exu_issue_uop.bits(0).bits.ps1.poke(2.U)
      dut.io.exu_issue_uop.bits(0).bits.fu_signals.opr1_sel.poke(OprSel.REG)
      dut.clock.step()
      dut.clock.step()
      dut.clock.step()
  ...
  "exu_issue" should "accept 2 instrs from dispatch unit and issue correctly" in {
    test(new exu_issue_queue()) { dut =>
      ...
      dut.io.exu_issue_uop.bits(0).valid.poke(1.U)
      dut.io.exu_issue_uop.bits(0).bits.iq_index.poke(4.U)
      dut.clock.step(3)
      println("test pass")
    }
  }
  ...
  "exu_issue" should "deal with MUL or DIV correctly" in {
    test(new exu_issue_queue()) { dut =>
      ...
      dut.io.exu_issue_uop.bits(0).valid.poke(1.U)
      dut.io.exu_issue_uop.bits(0).bits.instr_type.poke(InstrType.MUL)
      dut.io.exu_issue_uop.bits(0).bits.iq_index.poke(1.U)
      dut.io.exu_issue_uop.bits(1).valid.poke(1.U)
      dut.io.exu_issue_uop.bits(1).bits.instr_type.poke(InstrType.MUL)
      dut.io.exu_issue_uop.bits(1).bits.iq_index.poke(0.U)
      dut.clock.step()
      dut.io.exu_issue_uop.bits(0).valid.poke(0.U)
      dut.io.exu_issue_uop.bits(1).valid.poke(0.U)
      dut.clock.step()
  ...
  "exu_issue" should "deal with MUL and ALU correctly" in {
    test(new exu_issue_queue()) { dut =>
      ...
      dut.io.exu_issue_uop.bits(0).bits.iq_index.poke(1.U)
      dut.io.exu_issue_uop.bits(1).valid.poke(1.U)
      dut.io.exu_issue_uop.bits(1).bits.instr_type.poke(InstrType.ALU)
      dut.io.exu_issue_uop.bits(1).bits.iq_index.poke(0.U)
      dut.clock.step()
      dut.io.exu_issue_uop.bits(0).valid.poke(0.U)
      dut.io.exu_issue_uop.bits(1).valid.poke(0.U)
      ...
      dut.clock.step()
      dut.io.execute_uop(0).valid.expect(1.U)
      dut.io.mul_ready.poke(0)
      dut.clock.step(3)
      println("test pass")
    }
  ...
  "exu_issue" should "flush correctly when mispred" in {
    test(new exu_issue_queue()) { dut =>
      ...
      dut.io.exu_issue_uop.bits(0).valid.poke(1.U)
      dut.io.exu_issue_uop.bits(0).bits.iq_index.poke(3.U)
      dut.io.exu_issue_uop.bits(0).bits.instr_type.poke(InstrType.MUL)
      dut.io.exu_issue_uop.bits(1).valid.poke(1.U)
      dut.io.exu_issue_uop.bits(1).bits.iq_index.poke(4.U)
      dut.io.exu_issue_uop.bits(1).bits.fu_signals.opr1_sel.poke(OprSel.REG)
      dut.clock.step()
      dut.io.exu_issue_uop.bits(0).bits.iq_index.poke(2.U)
      dut.io.exu_issue_uop.bits(0).bits.instr_type.poke(InstrType.Branch)
      dut.io.exu_issue_uop.bits(0).bits.fu_signals.opr1_sel.poke(OprSel.REG)
      dut.io.exu_issue_uop.bits(1).bits.iq_index.poke(1.U)
      dut.io.exu_issue_uop.bits(1).bits.instr_type.poke(InstrType.DIV_REM)
      dut.clock.step()
      dut.io.exu_issue_uop.bits(0).valid.poke(0.U)
      dut.io.exu_issue_uop.bits(1).valid.poke(0.U)
